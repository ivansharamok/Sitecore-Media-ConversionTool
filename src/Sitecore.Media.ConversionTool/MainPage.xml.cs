namespace Sitecore.Media.ConversionTool
{
    ...
    using Data.Items;
    using Jobs;
    using Media.ConversionTool.Utils;
    ...
    public class MainPage : DialogForm
    {
        ...
        {
            string url = UIUtil.GetUri($"control:{DialogName}");
        ...
        {
            ListviewItem[] selectedItems = id.Length == 0 ? this.ItemList.SelectedItems : new ListviewItem[] { Context.ClientPage.FindControl(id) as ListviewItem };
